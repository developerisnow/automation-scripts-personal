...
export HISTSIZE=500000        # Количество команд в памяти
export SAVEHIST=500000        # Количество команд сохраняемых в файл
export HISTFILESIZE=1000000   # Максимальный размер файла истории
